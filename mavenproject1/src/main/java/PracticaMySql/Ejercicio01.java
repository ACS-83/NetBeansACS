...
public class Ejercicio01 {
	...
	/* Para el siguiente método, pensamos que era mejor usar la clase
	 * JFileChooser por varias razones. La primera para facilitar al usuario
	 * la carga del fichero mediante una ventana que se abrirá
	 * y permitirá escoger el fichero en la ruta que precise.
	 * La otra es que permite el filtrado y limitación de tipos de archivo
	 * mediante pocos ajustes.
	 * Como inconveniente tenemos comprobado que, al compilar el programa en Windows,
	 * la ventana se abre pero tenemos que localizarla a través de ALT + TAB para cambiar
	 * de ventana. Suele ocurrir con la mayoría de clases de JSwing.
	 */
