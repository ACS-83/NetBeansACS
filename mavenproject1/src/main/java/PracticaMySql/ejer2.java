...
/* 2.) Crea la clase ejer2 e incluye el método denominado creaTablaCoches() que en la Base de 
...
public class ejer2 {
	...
	public static void main (String args[]) {
		...
		try {
			...
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Concesionario?serverTimezone=" + horaLocal, "root", "root");
